...
public class ImageDownloader {
    public static void main(String[] args) {
    	// receive the array of packets
    	Packet[] randomPacket = PacketReceiver.receivePackets(502);
    	// sorts the random array of packets
    	PacketSorter.mergeSort(randomPacket, new PacketComparator());
        String imageOutputFilename = "finalImage.jpg";
        // render the image
        PacketRenderer.renderImage(randomPacket, imageOutputFilename);
    }
