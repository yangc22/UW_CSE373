...
public class IntegerSorter {
     ...
     * 				the integers to sort
     * @param newArray
     * 				the auxiliary array used to store the sorted integers
     * @param startIndex
     * 				start index for the array to be sorted
     * @param endIndex
     * 				end index for the array to be sorted
     * @param comparator
     * 				comparator used to compare the order of the given integer
     */
    private static void mergeSort(Integer[] array, Integer[] newArray, int startIndex,
    		int endIndex, Comparator<Integer> comparator) {
     ...
     * 				comparator used to compare the order of the given integer
     */
    private static void merge(Integer[] array, Integer[] newArray,
    		int startIndex, int midIndex, int endIndex,  Comparator<Integer> comparator) {
    		int i = startIndex;
    		int j = midIndex + 1;
    ...
    /**
     * finds the index of the minimum integer from the unsorted part
     * @param array
     * 				the array of integer that will be sorted
     * @param comparator
     * 				The comparator the will be used to compare two integers.
     ...
     * @return
     * 			the index of the minimum integer in the unsorted part
     */
    private static int findMin(Integer[] array, Comparator<Integer> comparator, int i) {
    	int min = array[i];
    	int position = i;
    ...
    /**
     * swap the integer at the current position with the minimum value in the unsorted part
     * @param array
     * 				the array of integer that will be sorted
     ...
     */
    private static void swap(Integer[] array, int unsortedPosition, int sortedPosition) {
